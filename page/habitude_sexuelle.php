...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    try {
        ...
        $Pratique_Cunilingus = htmlspecialchars($_POST['PPratiquez_vous_cunilingus'] ?? '');
        ...
        $sql = "INSERT INTO habitude_sexuelles (Numero_urap, Quel_type_rapport_avez_vous, Pratiquez_vous__fellation, Avez_vous_changé_partenais_ces_deux_dernier_mois, Utilisez_vous_preservatif, Pratiquez_vous_cunilingus) VALUES (?, ?, ?, ?, ?, ?)";
                        ...
                        <div class="form-field">
                            ...
                            <div class="radio-group">
                                <label for="jamais_cunilingus">
                                    <input type="radio" name="Pratiquez_vous_cunilingus" id="jamais_cunilingus" value="Jamais" <?php echo (isset($_POST['Pratiquez_vous__cunilingus']) && $_POST['Pratiquez_vous__cunilingus'] == 'Jamais') ? 'checked' : ''; ?> />
                                    <span>Jamais</span>
                                </label>
                                <label for="rarement_cunilingus">
                                    <input type="radio" name="Pratiquez_vous_cunilingus" id="rarement_cunilingus" value="Rarement" <?php echo (isset($_POST['Pratiquez_vous__cunilingus']) && $_POST['Pratiquez_vous__cunilingus'] == 'Rarement') ? 'checked' : ''; ?> />
                                    <span>Rarement</span>
                                </label>
                                <label for="quelquefois_cunilingus">
                                    <input type="radio" name="Pratiquez_vous_cunilingus" id="quelquefois_cunilingus" value="quelque fois" <?php echo (isset($_POST['Pratiquez_vous__cunilingus']) && $_POST['Pratiquez_vous__cunilingus'] == 'quelque fois') ? 'checked' : ''; ?> />
                                    <span>Quelque fois</span>
                                </label>
                                <label for="toujours_cunilingus">
                                    <input type="radio" name="Pratiquez_vous_cunilingus" id="toujours_cunilingus" value="Toujours" <?php echo (isset($_POST['Pratiquez_vous__cunilingus']) && $_POST['Pratiquez_vous__cunilingus'] == 'Toujours') ? 'checked' : ''; ?> />
                                    <span>Toujours</span>
                                </label>
                            </div>
                        </div>
