...
// ===== RÉCUPÉRATION DES DONNÉES MÉDICALES (CORRIGÉES) =====
...
// Examens médicaux (CORRECTIONS : retirer ORDER BY date_creation)
...
if ($patient && $patient['Sexe_patient'] == 'Masculin') {
    ...
    // Pour les femmes, récupération de tous les échantillons (pas de liaison numero_urap)
                ...
                <?php elseif ($ist_hommes): ?>
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            ...
                            <p><?= htmlspecialchars(date('d/m/Y H:i', strtotime($ist_hommes['date_creation']))) ?></p>
                        </div>
                    </div>
                <?php else: ?>
                    <div class="empty-section">
            ...
            <div class="section-content" id="content-examens">
                <?php if ($total_examens > 0): ?>
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            <h5>ECS #<?= $index + 1 ?> - Dr <?= htmlspecialchars($examen['medecin']) ?></h5>
                        ...
                        <div class="info-item">
                            <h5>Examen vaginal #<?= $index + 1 ?> - Dr <?= htmlspecialchars($examen['medecin']) ?></h5>
                        ...
                        <div class="info-item">
                            <h5>ECSU #<?= $index + 1 ?> - Dr <?= htmlspecialchars($examen['medecin']) ?></h5>
            ...
            <div class="section-content expanded" id="content-visites">
                <?php if (!empty($visites)): ?>
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            <h5>Visite #<?= $index + 1 ?> - <?= htmlspecialchars(date('d/m/Y', strtotime($visite['date_visite']))) ?></h5>
