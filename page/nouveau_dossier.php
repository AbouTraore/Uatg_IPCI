...
$patients = [];
try {
    $stmt = $pdo->query("SELECT Numero_urap, Nom_patient, Prenom_patient, Date_naissance, Age, Sexe_patient, Contact_patient, Adresse, Situation_matrimoniale, Lieu_résidence, Precise, Type_logement, Niveau_etude, Profession FROM patient");
...
<body>
        ...
        <div class="main-content">
            ...
            <div class="content-area">
                ...
                <div class="actions">
                    ...
                    <a href="visite.php" class="btn btn-accent" id="btnNouvelleVisite" style="pointer-events: none; opacity: 0.6;">
    ...
    <script>
        ...
        function selectPatient(index) {
            ...
            // Ne plus remplir le formulaire automatiquement
            // selectedPatientIndex reste mis à jour pour le bouton Modifier
