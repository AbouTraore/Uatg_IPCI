...
<h1><i class="fas fa-user-plus"></i> Nouveau Dossier</h1>
        ...
        <div class="form-grid">
          ...
          <div class="form-field">
            ...
            <div id="preciseContainer">
              ...
              <input type="text" class="form-input" id="PreciseInput" name="Precise" placeholder="Précisez le lieu de résidence" style="display: none;">
            </div>
          </div>
        </div>
      </div>
...
// Remplir le champ Precise selon le type

if (patient.Lieu_résidence === 'Abidjan') {

document.getElementById('PreciseSelect').value = patient.Precise || '';

} else {

document.getElementById('PreciseInput').value = patient.Precise || '';
